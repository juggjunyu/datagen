...
\begin{itemize}[nosep]
    ...
    \item \textbf{Figure text colors} (R4): Improvements to the text colors in Figures~3, 4, 5, and 7 are in progress.
\end{itemize}
