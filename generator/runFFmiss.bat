...
set OUTPUT_DIR=%BASE_DIR%\Face-Face-miss

:: 初始化计数器
set SUCCESS_COUNT=29
set ATTEMPT_COUNT=0
...
:: 使用唯一的日志文件名避免文件锁定问题
set LOG_FILE=generation_log_FFmiss_!ATTEMPT_COUNT!.txt

:: 运行生成器并捕获输出
echo 正在运行generator...
xmake r generator -t 6 -o "%OUTPUT_DIR%" > "!LOG_FILE!" 2>&1
