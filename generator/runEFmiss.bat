...
set BASE_DIR=E:\research\data\Animation\Edge-Face-miss
...
@REM Generator will create BASE_DIR\VV_seed + random number
set OUTPUT_DIR=%BASE_DIR%\Edge-Face-miss

:: 初始化计数器
set SUCCESS_COUNT=422
set ATTEMPT_COUNT=0
...
:: 使用唯一的日志文件名避免文件锁定问题
set LOG_FILE=generation_log_EFmiss_!ATTEMPT_COUNT!.txt

:: 运行生成器并捕获输出
echo 正在运行generator...
xmake r generator -t 7 -o "%OUTPUT_DIR%" > "!LOG_FILE!" 2>&1
