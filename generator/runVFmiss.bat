...
set BASE_DIR=E:\research\data\Animation\Vertex-Face-miss
...
set OUTPUT_DIR=%BASE_DIR%\Vertex-Face-miss
...
:: 使用唯一的日志文件名避免文件锁定问题
set LOG_FILE=generation_log_VFmiss_!ATTEMPT_COUNT!.txt

:: 运行生成器并捕获输出
echo 正在运行generator...
xmake r generator -t 9 -o "%OUTPUT_DIR%" > "!LOG_FILE!" 2>&1
