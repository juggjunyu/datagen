...
:: 运行生成器并捕获输出
echo 正在运行generator...
xmake r generator -t 2 -o %OUTPUT_DIR% > "generation_log_EE.txt" 2>&1

:: 显示输出结果
type "generation_log_EE.txt"

:: 检查是否包含"no collision"
findstr /C:"no collision" generation_log_EE.txt > nul
if %ERRORLEVEL% EQU 0 (
