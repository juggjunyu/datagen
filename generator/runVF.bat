...
set BASE_DIR=E:\research\data\Animation\Vertex-Face
@REM Generator will append _seed + random number to output directory name
@REM To create subdirectories under BASE_DIR, output directory should be BASE_DIR\VF
...
set LOG_FILE=generation_log_VF_!ATTEMPT_COUNT!.txt
